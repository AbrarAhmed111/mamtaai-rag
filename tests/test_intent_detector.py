...
@pytest.mark.parametrize("query,expected_intent", [
    ...
    ("how are you doing?", INTENT_WELLBEING),
    ("how are you doing today", INTENT_WELLBEING),
    ("how's it going?", INTENT_WELLBEING),
    ("whats up", INTENT_WELLBEING),
    ("who are you?", INTENT_BOT_IDENTITY),
    ("what is your name?", INTENT_BOT_IDENTITY),
    ("are you an ai?", INTENT_BOT_IDENTITY),
    ("you are awesome", INTENT_COMPLIMENT),
    ("nice to meet you", INTENT_PLEASANTRY),
    ("sorry", INTENT_APOLOGY),
    ("sorry about that", INTENT_APOLOGY),
    ("are you online?", INTENT_PING),
    ("ping", INTENT_PING),
])
